 ...
 * 
 */
package com.hypernovae.carpus.batch.scheduler.web;
...
public class WebTest {
	...
	private static final String BASE_URL = "http://localhost:8089/carpus-batch-scheduler/joblauncher";
	...
	private void startWebContainer() throws Exception {
		...
		wac.setWar("./src/test/resources/com/hypernovae/carpus/batch/scheduler/web/webapp/");
